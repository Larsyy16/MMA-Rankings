    ...
    <>
      ...
      <h3 className="fighterAbout"><em> About</em></h3>
        ...
        <p className="fighterParagraph">
          ...
          months of her career, she amassed an undefeated record of 5 wins (3 by
          TKO, 2 by decision) and 0 losses1. She is also a UFC analyst for UFC
          Español for Spanish broadcasts1. Grasso has had many triumphs
          throughout her career. She defeated Valentina Shevchenko for the
          flyweight championship at UFC 2862. She is also ranked #1 in the UFC
          women’s pound-for-pound rankings.
        </p>

        <Link className="fighterNextButton" to="/womens_bantamweight">
          {" "}
